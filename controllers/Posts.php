...
use Mail;
use Request;
use Quangtrong\News\Models\Posts as Item;
use Quangtrong\News\Classes\NewsSender;
...
class Posts extends Controller
{
    ...
    public $requiredPermissions = ['quangtrong.news.posts'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Quangtrong.News', 'news', 'posts');
    }
    ...
    public function onTest()
    {
        ...
        if ($sender->sendTestNewsletter()) {
            ...
            Flash::error(trans('quangtrong.news::lang.flash.newsletter_test_error'));
        }
    }
    ...
    public function onNewsSend()
    {
        ...
        if ($news->last_send_at === null) {
            ...
            if ($sender->sendNewsletter()) {
                Flash::success(trans('quangtrong.news::lang.flash.newsletter_send_success'));
            }
            else {
                Flash::error(trans('quangtrong.news::lang.flash.newsletter_send_error'));
            }
        }
        else {
            Flash::error(trans('quangtrong.news::lang.flash.newsletter_send_error'));
    ...
    public function onNewsResend()
    {
        ...
        if ($sender->resendNewsletter()) {
            ...
            Flash::success(trans('quangtrong.news::lang.flash.newsletter_resend_success'));
        }
        else {
            Flash::error(trans('quangtrong.news::lang.flash.newsletter_resend_error'));
        }
    ...
    public function onActivatePosts()
    {
        if (($checkedIds = post('checked')) && is_array($checkedIds) && count($checkedIds)) {
            ...
            Flash::success(Lang::get('quangtrong.news::lang.flash.activate'));
        }
