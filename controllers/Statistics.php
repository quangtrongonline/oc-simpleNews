...
use BackendMenu;
use Quangtrong\News\Models\Logs;
use Quangtrong\News\Models\Posts;
use Quangtrong\News\Models\Settings;
use Db;
use Backend;

class Statistics extends Controller
{
    public $requiredPermissions = ['quangtrong.news.statistics'];

    public function __construct()
    {
        parent::__construct();

        BackendMenu::setContext('Quangtrong.News', 'news', 'statistics');
    }
    ...
    public function index()
    {
        ...
        $this->pageTitle = 'quangtrong.news::lang.menu.statistics';
    }
        ...
        foreach ($news as $item) {
            $top .= '
                ...
                <div class="col-md-9 col-sm-9">
                    <a href="'.Backend::url('quangtrong/news/posts/update/'.$item->id).'">'.$item->title.'</a>
                </div>
    ...
    {
        $log['queued'] = Db::table('quangtrong_news_newsletter_logs')
        ...
        $log['send'] = Db::table('quangtrong_news_newsletter_logs')
        ...
        $log['viewed'] = Db::table('quangtrong_news_newsletter_logs')
        ...
        $log['clicked'] = Db::table('quangtrong_news_newsletter_logs')
        ...
        $this->vars['logResultsFieldsTrans'] = array_map(function($t) {
            return trans('quangtrong.news::lang.stat.'.$t);
        }, array_keys($log));
    }
}
