    ...
    public function scopeListFrontEnd($query, $options)
    {
        ...
        if ($isTrans) {
            ...
            if ($current_locale != $default_locale) {
                $ids = Db::table('rainlab_translate_attributes')->where('model_type', 'Quangtrong\News\Models\Posts')->where('locale', $current_locale)->where('attribute_data', 'not like', '%"title":""%')->pluck('model_id')->toArray();
